...
def create_all_intents_and_save():
    ...
    admission_new_applicant_questions_answers_array = scraping_admissions.get_admission_process_questions_answers(
        "https://www.uac.edu.co/admisiones-y-registro/pregrado/nuevo-aspirante", ["procedimiento de inscripcion estudiante nuevo", "proceso de inscripcion estudiante nuevo", "procedimiento de admisión estudiante nuevo", "proceso de admisión estudiante nuevo", "procedimiento de inscripcion aspirante nuevo", "proceso de inscripción aspirante nuevo", "procedimiento de admisión aspirante nuevo", "proceso de admisión aspirante nuevo"])
    admission_external_transfer_applicant_questions_answers_array = scraping_admissions.get_admission_process_questions_answers(
        "https://www.uac.edu.co/admisiones-y-registro/pregrado/aspirante-transferencia-externa", ["procedimiento de inscripcion estudiante transferencia externa", "proceso de inscripcion estudiante transferencia externa", "procedimiento de admisión estudiante transferencia externa", "proceso de admisión estudiante transferencia externa", "procedimiento de inscripcion aspirante transferencia externa", "proceso de inscripción aspirante transferencia externa", "procedimiento de admisión aspirante transferencia externa", "proceso de admisión aspirante transferencia externa"])
    ...
    admission_reentry_applicant_questions_answers_array = scraping_admissions.get_admission_process_questions_answers(
        "https://www.uac.edu.co/admisiones-y-registro/pregrado/reingreso", ["procedimiento de inscripcion estudiante reingreso", "proceso de inscripcion estudiante reingreso", "procedimiento de admisión estudiante reingreso", "proceso de admisión estudiante reingreso", "procedimiento de inscripcion aspirante reingreso", "proceso de inscripción aspirante reingreso", "procedimiento de admisión aspirante reingreso", "proceso de admisión aspirante reingreso"])
    admission_foreign_applicant_questions_answers_array = scraping_admissions.get_admission_process_questions_answers(
        "https://www.uac.edu.co/admisiones-y-registro/posgrado/extranjero", ["procedimiento de inscripcion estudiante extranjero", "proceso de inscripcion estudiante extranjero", "procedimiento de admisión estudiante extranjero", "proceso de admisión estudiante extranjero", "procedimiento de inscripcion aspirante extranjero", "proceso de inscripción aspirante extranjero", "procedimiento de admisión aspirante extranjero", "proceso de admisión aspirante extranjero"])
    ...
    procedure_supplemental_exam_questions_answers_array = scraping_procedures.get_procedures_requests_questions_answers(
        "https://www.uac.edu.co/admisiones-y-registro/registro-y-control/examen-supletorio", ["procedimiento examen supletorio", "proceso examen supletorio", "trámite examen supletorio"])
